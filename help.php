...
&lt;/a&gt;</code></pre>
		...
		<p><?php _e( 'The Social Bartender plugin was created by', 'shaken' ); ?> <a href="http://shakenandstirredweb.com">Shaken and Stirred Web</a>. <?php _e( 'If you find any bugs or have feature requests, please leave your feedback on the plugin\'s Github page:', 'shaken' ); ?></p>
